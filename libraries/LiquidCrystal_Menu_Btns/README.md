## LiquidCrystal_Menu_Btns
**LiquidCrystal_Menu_Btns** - это библиотека для создания пользовательского интерфейса на Ардуино и текстовом ЖК дисплее с I2C интерфейсом. Библиотека предоставляет функционал для форматированного вывода, ввода и выбора значений, организации меню. Управление осуществляется с помощью кнопок.

## Подключение
[![LiquidCrystal_Menu_Btns подключение](https://github.com/VladimirTsibrov/LiquidCrystal_Menu_Btns/raw/master/wiring/LiquidCrystal_Menu_Btns%20wiring.png "LiquidCrystal_Menu_Btns подключение")](https://github.com/VladimirTsibrov/LiquidCrystal_Menu_Btns/raw/master/wiring/LiquidCrystal_Menu_Btns%20wiring.png "LiquidCrystal_Menu_Btns подключение")

## Управление энкодером вращения
Вместо кнопок может быть использован энкодер вращения. Для этого существует другая версия данной библиотеки - [LiquidCrystal_Menu](https://github.com/VladimirTsibrov/LiquidCrystal_Menu "LiquidCrystal_Menu")
...
Для включения поддержки дисплеев с кириллицей необходимо в файле LiquidCrystal_Menu_Btns.h раскомментировать строку #define CYRILLIC_DISPLAY. После этого станет возможным использование русского текста в меню и других функциях библиотеки.
